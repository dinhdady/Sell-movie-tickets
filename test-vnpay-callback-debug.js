// Test VNPay callback trực tiếp
const testVNPayCallback = async () => {
  ...
  console.log('📞 Calling VNPay callback URL:', callbackUrl);
  ...
  try {
    ...
    console.error('❌ Error calling VNPay callback:', error);
  }
};
