# Script để test email verification cuối cùng
Write-Host "🧪 Testing email verification final..." -ForegroundColor Yellow
...
Write-Host "`n🔍 Backend fixes applied:" -ForegroundColor Blue
Write-Host "✅ Fixed EmailVerificationToken setUsed() method" -ForegroundColor Green
Write-Host "✅ Changed from @Data to @Getter @Setter" -ForegroundColor Green
Write-Host "✅ Restarted backend server" -ForegroundColor Green

Write-Host "`n🔍 Frontend fixes applied:" -ForegroundColor Blue
Write-Host "✅ Added preventRedirectRef to prevent auto-redirect" -ForegroundColor Green
Write-Host "✅ Added safeNavigate function" -ForegroundColor Green
Write-Host "✅ Updated all navigation buttons" -ForegroundColor Green
Write-Host "✅ Added debug logs" -ForegroundColor Green
